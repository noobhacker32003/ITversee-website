              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="border-b border-white/10 bg-white/5">
                    <th className="px-6 py-4 font-bold text-sm uppercase tracking-wider text-accent">
                      Name
                    </th>
                    <th className="px-6 py-4 font-bold text-sm uppercase tracking-wider text-accent">
                      Contact Info
                    ...
                    <th className="px-6 py-4 font-bold text-sm uppercase tracking-wider text-accent text-right">
                      Date
                    </th>
                  </tr>
                </thead>
